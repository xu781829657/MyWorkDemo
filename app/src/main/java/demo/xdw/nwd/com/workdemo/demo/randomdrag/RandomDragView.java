package demo.xdw.nwd.com.workdemo.demo.randomdrag;
...
/**
 * Created by xudengwang on 2016/10/24.
 */

public class RandomDragView extends View {
    ...
    public RandomDragView(Context context, AttributeSet attrs) {
        super(context, attrs);
        paint = new Paint();
