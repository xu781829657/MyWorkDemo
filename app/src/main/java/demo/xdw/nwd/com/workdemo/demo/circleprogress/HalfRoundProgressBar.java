...
public class HalfRoundProgressBar extends View {
	...
	public HalfRoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		//roundWidth = (roundWidth- Base.getDisplayMetrics().density * 5);
...
//			LinearGradient shader = new LinearGradient(3, 3, 50 , 50, colors, null,
//					Shader.TileMode.CLAMP);

//			LinearGradient lg = new LinearGradient(0,0,getMeasuredWidth()/2,getMeasuredHeight()/2,Color.BLUE,Color.RED,Shader.TileMode.MIRROR);
//			paint.setShader(lg);
			//canvas.drawArc(oval, -40, 360 * progress / max, false, paint);  //根据进度画圆弧
			canvas.drawArc(oval, 140,  260 * 40 / max, false, paint);  //根据进度画圆弧
			break;
		}
		case FILL:{
