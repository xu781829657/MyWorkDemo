...
/**
 * Created by xudengwang on 2017/3/28.
 */
public class Image3dView extends View {
    ...
    public void setSourceView(View view) {
        sourceView = view;
        sourceHeight = sourceView.getHeight();
        LogUtils.d("-----------------setSourceView sourceHeight:" + sourceHeight);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 计算图片需要旋转的角度
        float degree = ((90 / sourceHeight) * getHeight()-90);
        LogUtils.d("degree:" + degree + ",getHeight():" + getHeight() + ",sourceHeight:" + sourceHeight);
        camera.save();
